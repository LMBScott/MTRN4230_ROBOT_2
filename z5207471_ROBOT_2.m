...
function z5207471_ROBOT_2(paperPose, digits)
    ...
    CHAR_WIDTH = 20;    % Character width in millimeters
    ...
    for i = 1 : strlength(digits)
        ...
        switch digits(i)
            case '0'
                ...
                poses = moveC(ur5, paperPose, poses, rot, arc, nextPos);
                % Draw RHS of zero
                currPos = nextPos;
            ...
            case '1'
                ...
                poses = moveL(ur5, paperPose, poses, rot, nextPos);
            ...
            case '4'
                ...
                nextPos = [ charEdgePos(1) + CHAR_HEIGHT * 0.8, charEdgePos(2) + CHAR_SIDE_PADDING, PLANE_Z_OFFSET ];
                poses = moveL(ur5, paperPose, poses, rot, nextPos);
        ...
        charEdgePos(2) = charEdgePos(2) + CHAR_WIDTH + CHAR_SPACING;
    end
